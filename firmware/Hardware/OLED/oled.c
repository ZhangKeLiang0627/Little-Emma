...
void OLED_Init(void)
{
	...
	rcu_periph_clock_enable(RCU_I2C0);//打开i2c0时钟
	rcu_periph_clock_enable(RCU_AF);//打开复用时钟
	
	gpio_pin_remap_config(GPIO_I2C0_REMAP, ENABLE);//对i2c0进行引脚重映射至pb8/pb9
	//gpio初始化
